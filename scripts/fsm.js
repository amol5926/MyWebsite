...
var openFSM = function (event) {
    ...
    $fsmActual.style.zIndex = '9999'; // add z-index property
...
var portfolioWrapList = document.querySelectorAll('.portfolio-wrap');
var portfolioInfoList = document.querySelectorAll('.portfolio-info');

var openFSM = function (event) {
    // Loop through each portfolio-info element and add the "hide" class
    portfolioInfoList.forEach(function (info) {
...
var closeFSM = function (event) {
    // Loop through each portfolio-info element and remove the "hide" class
    portfolioInfoList.forEach(function (info) {
...
// Loop through each portfolio-wrap element and attach the click event listener
portfolioWrapList.forEach(function (wrap) {
    wrap.addEventListener('click', openFSM);
});
